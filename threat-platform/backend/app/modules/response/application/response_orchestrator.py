...
class ResponseOrchestrator:
    def __init__(self, db: AsyncSession):
        ...
        # Real executors first, NoopExecutor last as the catch-all.
        # In development everything falls through to Noop — nothing is ever really blocked.
        self.executors: list[BaseExecutor] = [MonitorExecutor(), NoopExecutor()]
